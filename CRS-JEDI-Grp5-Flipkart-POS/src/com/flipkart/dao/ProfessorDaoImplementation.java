...
//            statement.setString(1,username);
    ...
    public List<Course> viewAlreadyRegisteredCourses(String username) {
        Connection connection = DBUtil.getConnection();
        List<Course> viewAvailableCouse = new ArrayList<Course>();
        try {
            PreparedStatement statement = connection.prepareStatement(SQLQueries.ALREADY_REGISTERED_COURSES_PROFESSOR);
            statement.setString(1,username);
            ResultSet rs = statement.executeQuery();
